...
{
    return (
        <div className='px-4 py-[9px] bg-[#F2F2F2] space-x-2 flex grow items-center rounded-md max-sm:px-2 max-sm:py-1.5 max-sm:grow-0 max-sm:space-x-1.5'>
  ...
  return (
    <nav className='bg-white flex items-center px-8 py-3 space-x-4 fixed top-0 right-0 z-30 max-sm:px-0 max-sm:space-x-2 max-sm:justify-between w-[calc(100vw-320px)] border-b-2 border-gray-400/70 pb-4'>
        ...
        <aside className='flex items-center space-x-2.5 grow max-sm:space-x-1 max-sm:grow-0'>
            <svg className="max-sm:w-3 max-sm:h-3" width="18" height="18" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section className='flex space-x-3 grow justify-end max-sm:grow-0 max-sm:space-x-1 max-sm:items-center'>
            <aside className=' p-3 bg-[rgb(230,230,230)] rounded-full hover:cursor-pointer max-sm:p-1.5'>
